...
class SentryPlayer(Player):
    def __init__(self, game, player_name, starting_cards):
        super(SentryPlayer, self).__init__(game,  player_name, starting_cards)
    ...
    def get_card_to_buy(self, money, buys, forced = False):
        ...
        if self.can_buy("Province", money) and get_total_economy(self) >= 18:
            ...
            return "Gold"
        elif self.can_buy("Sentry", money) and cards_in_deck("Sentry", self) < 2:
            return "Sentry"
